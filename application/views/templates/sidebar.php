      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('distributor') ?>">Data Distributor</a>
            <a class="collapse-item" href="<?php echo base_url('pasok') ?>">Data Pasok</a>
            <a class="collapse-item" href="<?php echo base_url('buku') ?>">Data Buku</a>
            <a class="collapse-item" href="<?php echo base_url('penjualan') ?>">Data Penjualan</a>
          </div>
        </div>
      </li>
